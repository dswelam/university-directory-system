 ...
 * This class ensures that the CourseRecordIO class correctly reads and writes course records.
 * Additionally, it tests the behavior of setting and handling instructor IDs, including cases
 * where the instructor ID is null.
 * 
 * @author Dania Swelam
 */
public class CourseRecordIOTest {
    ...
    /** Expected results for valid courses in course_records.txt - line 5 */
    ...
    /**
     * Tests reading valid course records from a file.
     * Ensures that all expected courses are read correctly.
     */
    @Test
    ...
    /**
     * Tests reading invalid course records from a file.
     * Ensures that no invalid courses are read.
     */
    @Test
    ...
    /**
     * Tests writing course records to a file.
     * Ensures that the records are written correctly and the output matches the expected file.
     */
    @Test
     ...
     * 
     * @param expFile expected output file path
     * @param actFile actual output file path
     */
